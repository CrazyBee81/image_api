...
describe('Test if files are been processed and delivered', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, sharp_1.default)("".concat(fileDirectory, "/friends.jpg"))];
                case 1:
                    image = _a.sent();
                    return [4 /*yield*/, image.resize(1, 1)
                            .toFile("".concat(fileDirectory, "/friends_1_1.jpg"))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('an image gets processed and safed', function () { return __awaiter(void 0, void 0, void 0, function () {
        var myFile;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1.promises.open("".concat(fileDirectory, "/friends_1_1.jpg"), 'a+')];
                case 1:
                    myFile = _a.sent();
    ...
    it('comes in the expacted format', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1.promises.unlink("".concat(fileDirectory, "/friends_1_1.jpg"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
